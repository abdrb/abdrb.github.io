...
$subject = "Find employ by LCIT website" ;

$formurl = "http://www.londoncit.com/findemp.htm" ;
$errorurl = "http://www.londoncit.com/error.htm" ;
$coderrorurl = "http://www.londoncit.com/codeerror.htm" ;
$thankyouurl = "http://www.londoncit.com/findempthanku.htm" ;
...
$messageproper =
        ...
        "Êáİæä ÇáÔÑßÉ: $T1\n" .
        "İÇßÓ ÇáÔÑßÉ: $T2\n" .
        "Êáİæä ÕÇÍÈ ÇáÔÑßÉ: $T3\n" .
        "ÇáÏæÑÇÊ ÇáãØáæÈ ÅÌÊíÇÒå: $newLeft\n" .
        "ãŞÑ ÇáÔÑßÉ: $L1\n" .
        "äæÚ ÇáãæÙİ: $L2\n" .
        "ÇáãÄåá ÇáãØáæÈ: $email\n" .
